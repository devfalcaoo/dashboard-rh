// ==========================================================================
// ARQUIVO: backend/validators/equipeValidator.js
// OBJETIVO: Validar os payloads de entrada das rotas de equipes.
// ==========================================================================

const TAMANHO_MAXIMO_NOME = 150;

/**
 * @param {{ nome: string, liderId?: string }} dados
 * @returns {{ valido: boolean, erros: string[] }}
 */
function validarCriarEquipe(dados) {
  const erros = [];
  const { nome } = dados || {};
...
/**
 * @param {{ nome?: string, liderId?: string, ativo?: boolean }} dados
 * @returns {{ valido: boolean, erros: string[] }}
 */
function validarAtualizarEquipe(dados) {
  const erros = [];
...
/**
 * @param {{ colaboradorId: string }} dados
 * @returns {{ valido: boolean, erros: string[] }}
 */
function validarAdicionarMembro(dados) {
  const erros = [];
  const { colaboradorId } = dados || {};
